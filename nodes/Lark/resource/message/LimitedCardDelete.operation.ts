...
export default {
	...
	options: [
		...
		{
			displayName: `<a target="_blank" href="${getDocumentationUrl('/document/server-docs/im-v1/message-card/delete-message-cards-that-are-only-visible-to-certain-people')}">${WORDING.OpenDocument}</a>`,
			name: 'notice',
			type: 'notice',
			default: '',
		},
