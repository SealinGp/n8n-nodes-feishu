...
export default {
	...
	options: [
		...
		{
			displayName: WORDING.UiMergeType,
			name: 'mergeType',
			type: 'options',
			options: [
		...
		{
			displayName: `<a target="_blank" href="${getDocumentationUrl('/document/server-docs/docs/sheets-v3/data-operation/merge-cells')}">${WORDING.OpenDocument}</a>`,
			name: 'notice',
			type: 'notice',
			default: '',
		},
