...
export default {
	...
	options: [
		...
		{
			displayName: `<a target="_blank" href="${getDocumentationUrl('/document/server-docs/docs/bitable-v1/advanced-permission/app-role-member/batch_delete')}">${WORDING.OpenDocument}</a>`,
			name: 'notice',
			type: 'notice',
			default: '',
		},
