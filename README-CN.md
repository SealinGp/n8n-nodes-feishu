...
本项目 fork 自 [@zhgqthomas/n8n-nodes-feishu-lark](https://github.com/zhgqthomas/n8n-nodes-feishu-lark) → [@SealinGp/n8n-nodes-feishu-api](https://github.com/SealinGp/n8n-nodes-feishu-api) → 本项目。感谢原作者的开源贡献。本 fork 在必要重构的基础上补充了缺失的英文翻译，以支持完善的多语言运行。
